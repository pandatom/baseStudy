...
public class TemplateConfig {
	 ...
	 * 添加页面生成模板配置
	 */
	private String mainPage = ConstVal.TEMPLATE_MAIN_PAGE;
	private String editPage = ConstVal.TEMPLATE_EDIT_PAGE;
	...
	public TemplateConfig setMainPage(String mainPage) {
	...
	public TemplateConfig setEditPage(String editPage) {
