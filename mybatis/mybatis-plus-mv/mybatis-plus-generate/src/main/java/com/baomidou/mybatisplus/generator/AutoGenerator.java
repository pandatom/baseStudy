...
public class AutoGenerator {
	...
	private void batchOutput(String entityName, VelocityContext context) {
		try {
			...
			String mainPageFile = String.format((pathInfo.get(ConstVal.PAGE_PATH) + File.separator + tableInfo.getEntityPath()+ File.separator +"main"+ ConstVal.PAGE_SUFFIX), entityName);
			String editPageFile = String.format((pathInfo.get(ConstVal.PAGE_PATH) + File.separator + tableInfo.getEntityPath() + File.separator +"edit"+ ConstVal.PAGE_SUFFIX), entityName);
			...
			if (isCreate(mainPageFile)) {
				vmToFile(context, template.getMainPage(), mainPageFile);
			}
			if (isCreate(editPageFile)) {
				vmToFile(context, template.getEditPage(), editPageFile);
			}
